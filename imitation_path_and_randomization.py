"""
imitation_path_and_randomization.py
-------------------------
...
def check_and_create_config_paths(stim_path, practice_stim_path, pics_path,
                                  output_path, record_path, random_path,
                                  participant_info):
    """
    Check the existence of provided paths and create directories if they don't exist.

    Parameters:
    - stim_path (str): Path to the directory containing test stimuli.
    - practice_stim_path (str): Path to the directory containing practice stimuli.
    - output_path (str): Directory where output results will be stored.
    - pics_path (str): Directory containing picture stimuli.
    - record_path (str): Directory where recordings will be saved.
    - random_path (str): Directory where randomized stimuli will be stored.
...
def load_stimuli(stim_path):
    ...
    Parameters:
    - stim_path (str): Directory path where stimuli files are located.
